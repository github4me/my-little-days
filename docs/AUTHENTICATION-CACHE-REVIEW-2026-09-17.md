...
Native iPhone acceptance, authenticated production sign-in/cache behavior and Expo/TestFlight publication remain unperformed for this change. No Azure registration/consent, secret or settings changes were required or performed for the approved reuse decision. The anonymous checks establish rollout and authentication enforcement, not real-user or two-device acceptance.
